...
MY_MODULES = board.o tetromino.o randomHardware.o input.o game.o startend.o\
		printf.o ps2.o strings.o \
		timer.o fb.o gl.o gpio.o keyboard.o malloc.o

# Targets for this makefile
APPLICATION = build/tetris.bin
TEST 	    = build/tetris-tests.bin
...
CFLAGS	= -I src/lib -I$(CS107E)/include  -Og -g -std=c99 $$warn $$freestanding
